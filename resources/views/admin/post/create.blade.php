...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="{{ route('admin.posts.index') }}">News</a></li>
...
<section class="content">
	<div class="box">
		<div class="box-header with-border">
			...
			<div class="box-tools">
				<a href="{{ route('admin.posts.index') }}" class="btn btn-info btn-sm btn-flat"><i class="fa fa-list"></i> Manage News</a>
			</div>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
			<form name="post_add_form" class="form-horizontal" action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
					<label for="post_title" class="col-md-2 control-label">News Title</label>
					<div class="col-md-9">
						<input type="text" name="post_title" class="form-control" id="post_title" value="{{ old('post_title') }}" placeholder="ex: post title">
				...
				<div class="form-group{{ $errors->has('post_slug') ? ' has-error' : '' }}">
					<label for="post_slug" class="col-md-2 control-label">News Slug</label>
					<div class="col-md-9">
						<input type="text" name="post_slug" class="form-control" id="post_slug" value="{{ old('post_slug') }}" placeholder="ex: post-slug">
				...
				<div class="form-group{{ $errors->has('post_date') ? ' has-error' : '' }}">
					<label for="post_date" class="col-md-2 control-label">News Date</label>
					<div class="col-md-5">
				...
				<div class="form-group{{ $errors->has('post_tags') ? ' has-error' : '' }}">
					<label for="post_tags" class="col-md-2 control-label">News Tag</label>
					<div class="col-md-9">
				...
				<div class="form-group{{ $errors->has('post_details') ? ' has-error' : '' }}">
					<label for="post_details" class="col-md-2 control-label">News Details</label>
					<div class="col-md-9">
				...
				<div class="form-group{{ $errors->has('meta_title') ? ' has-error' : '' }}">
					...
					<div class="col-md-9">
						<input type="text" name="meta_title" class="form-control" id="meta_title" value="{{ old('meta_title') }}" placeholder="ex: post title">
				...
				<div class="form-group{{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
					...
					<div class="col-md-9">
						<input type="text" name="meta_keywords" class="form-control" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="ex: post, title">
				...
				<div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
					...
					<div class="col-md-9">
						<textarea name="meta_description" id="meta_description" class="form-control" rows="3" placeholder="ex: post dscription">{{ old('meta_description') }}</textarea>
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-10">
						<button type="submit" class="btn btn-info btn-flat">Add News</button>
					</div>
				</div>
			</form>
		</div>
