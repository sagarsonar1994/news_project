		...
		<div class="box-body">
			<form name="post_edit_form" class="form-horizontal" action="{{ route('admin.posts.update', $post->id) }}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
					...
					<div class="col-md-9">
						<input type="text" name="post_title" class="form-control" id="post_title" value="{{ $post->post_title }}" placeholder="ex: news title">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-10">
						<button type="submit" class="btn btn-info btn-flat">Edit News</button>
					</div>
				</div>
			</form>
		</div>
