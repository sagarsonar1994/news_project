...
Route::group(['prefix' => '/'], function () {
    ...
    Route::get('/advertise', ['as' => 'advertisePage', 'uses' => 'WebController@advertisePage']);
    Route::get('/contact', ['as' => 'contactPage', 'uses' => 'WebController@contactPage']);
    Route::get('/about', ['as' => 'aboutPage', 'uses' => 'WebController@aboutPage']);
    Route::get('/privacy', ['as' => 'privacyPage', 'uses' => 'WebController@privacyPage']);
    ...
    Route::get('/category/news/{slug}', ['as' => 'categoryPageName', 'uses' => 'WebController@categoryDetail']);
    ...
    Route::get('/firstPage', ['as' => 'firstPage', 'uses' => 'PublicController@firstPage']);
    // Route::get('/categoryPage', ['as' => 'categoryPage', 'uses' => 'PublicController@categoryPage']);
